module controller {
    export class ControllerFactory {
        constructor(configuration:model.Configuration, services:service.ServiceFactory) {
            ...
            this.user = new controller.impl.UserControllerImpl(services.authorise, services.user.read, services.user.update, services.user.deletion);
            this.users = new controller.impl.UserCollectionControllerImpl(configuration.host, services.user.create);
            this.project = new controller.impl.ProjectControllerImpl(services.authorise, services.project.read, services.project.update, services.project.deletion);
